    ...
    <div className="relative w-full min-h-[78svh] flex items-center overflow-x-hidden">
      ...
      <div className="relative z-10 w-full max-w-[1570px] mx-auto pr-6 pl-10 md:pl-24 lg:pl-26 xl:pl-28">
        <div className="text-primary">
          ...
          <h2 className="font-raleway font-bold text-[clamp(32px,6vw,88px)] max-w-[890px] leading-[0.95]">
            {slideTitle}
          </h2>

          <p className="mt-6 font-raleway text-[clamp(16px,2.5vw,27px)] max-w-[400px]">
            {slideSubtitle}
          </p>

          <div className="mt-8 sm:mt-10">
            <Link href={linkHref}>
              <PrimaryButton className="px-6 py-3 md:px-8 md:py-4 lg:px-12 lg:py-5 xl:px-16 xl:py-6">
                {slideCta}
              </PrimaryButton>
            </Link>
          </div>
