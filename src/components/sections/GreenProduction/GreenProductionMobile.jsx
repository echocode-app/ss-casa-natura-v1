    ...
    <div className="md:hidden flex flex-col gap-3 items-center">
      ...
      <div className="flex gap-2 justify-evenly w-full items-start">
        <div className="flex flex-col items-center gap-2 max-w-[85px] mt-6">
          ...
          <p className="text-center text-[14px]">Solo ingredienti vegetali</p>
        </div>
        ...
        <div className="flex flex-col items-center gap-2 max-w-[85px]">
          ...
          <p className="text-center text-[14px]">Prodotti realizzati senza test sugli animali</p>
        </div>
        ...
        <div className="flex flex-col items-center gap-2 max-w-[85px] mt-6">
          ...
          <p className="text-center text-[14px]">Qualità 100% Made in Italy</p>
        </div>
      </div>

      {/* planet */}
      <div className="flex justify-center">
        <GreenPlanet width={240} height={240} />
      </div>
    </div>
  );
}
