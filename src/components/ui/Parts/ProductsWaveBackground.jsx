export default function ProductsWaveBackground({ color = '#F9F8D6', className = '' }) {
  return (
    <div
      aria-hidden
      className={`
      ...
      `}
    >
      <svg viewBox="0 0 1800 1000" preserveAspectRatio="xMidYMin slice" className="w-full h-full">
        <path
          d="
            M1845 790.861
            H1931.5
