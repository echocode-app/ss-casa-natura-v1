    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        <div className="mb-8">
          ...
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">Qualcosa è andato storto</h2>
          <p className="text-gray-600">
            Si è verificato un errore durante il caricamento della pagina. Riprova o torna alla home
            page.
          </p>
